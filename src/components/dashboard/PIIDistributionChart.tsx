    ...
    return (
      <div className="h-[300px] w-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">Analyzing PII distribution...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-[300px] w-full flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm font-medium text-foreground">No PII data found</p>
          <p className="text-xs text-muted-foreground mt-1">
            Run a scan to detect PII fields in your database
          </p>
        </div>
      </div>
    );
