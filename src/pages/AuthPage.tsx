 ...
 * 
 * Uses the shared Layout so the sidebar is visible on desktop (sticky, no overlap)
 * and hidden as a floating drawer on mobile.
 */
  ...
  return (
    <Layout>
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] px-4 py-8">
        <Card className="glass-effect w-full max-w-md shadow-2xl border-violet-500/10">
